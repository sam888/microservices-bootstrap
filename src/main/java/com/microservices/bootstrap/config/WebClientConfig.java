...
public class WebClientConfig {
    ...
    @Value("${app.transaction-url}")
    private String transactionUrl;

    @Value("${api.url.westpac}")
    private String westpacUrl;


    public WebClientConfig(ExchangeStrategies exchangeStrategies) {
    ...
    public WebClient authWebClient() {
        return getWebClient( authUrl );
    }

    @Bean
    public WebClient transactionWebClient() {
        return getWebClient( transactionUrl );
    }

    @Bean
    public WebClient westpacWebClient() {
