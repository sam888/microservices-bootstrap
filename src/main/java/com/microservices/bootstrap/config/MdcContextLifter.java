...
/**
 * Helper that copies the state of Reactor [Context] to MDC on the #onNext function. Courtesy of
 * <a href="https://github.com/archie-swif/webflux-mdc/blob/master/src/main/java/com/example/webfluxmdc/MdcContextLifter.java">...</a>
 */
